...
const { adminDetails, userOneDetails, userTwoDetails } = require('../fixtures/user.fixture')
...
describe('User routes', () => {
  ...
  beforeAll(async () => {
    ...
    userTwo = await User.create(userTwoDetails)
    adminAccessToken = tokenService.generateToken(admin.id, accessTokenExpires, tokenTypes.ACCESS)
    userOneAccessToken = tokenService.generateToken(userOne.id, accessTokenExpires, tokenTypes.ACCESS)
  })
